...
export default function Home() {
  return (
    <div>
      <div className="bg-base-100 container m-auto w-300 p-5 pt-5 max-md:w-100">
                ...
                <div className="m-auto w-90 min-md:w-80 min-md:flex-1 min-md:pt-20">
                  <div className="card bg-primary card-sm shadow-sm">
                    <div className="card-body">
                      <button
                        className="card-title btn bg-primary border-primary justify-start text-2xl text-white"
                      >
                        SAO-RPG Dice Roller
                      </button>
                    </div>
                  ...
                  <div className="card-xs">
                    <div className="card-body p-0">
                      ...
                      <div
                        className="bg-base-100/80 border-base-100/30 m-auto flex flex-row gap-1 rounded-lg border-1"
                      >
                        <div>
                          <div
                            className="tooltip tooltip-top grow"
                            style={{ "--tt-off": "calc(120%)" }}
                          >
                            <label
                            ...
                            <div className="tooltip-content text-xs">Settings</div>
                          </div>
                        </div>
                        <div>
                          <div
            ...
            <div className="w-90">
              <div className="tabs tabs-lift">
                <label className="tab text-primary">
                  <input type="radio" name="sao_roller" checked={true} readOnly={true}/>
                ...
                <div className="tab-content bg-base-100 border-base-300">
                  <div className="flex flex-col">
                    ...
                    <div className="bg-base-100 collapse-arrow collapse pl-1.5">
                      <input type="checkbox" />
                      <div
                        className="collapse-title text-base-content/35 text-ssm/8 font-semibold"
                      >
                        Search by Name.
                      </div>
                      <div className="collapse-content text-sm">
